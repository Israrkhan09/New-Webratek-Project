...
const TABS = [
  ...
  },
  {
    ...
    color: '#11A894',
    portfolioImages: [
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/ecommerce/half/1.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/ecommerce/half/2.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/ecommerce/half/3.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/ecommerce/half/4.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/ecommerce/half/5.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/ecommerce/half/6.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/ecommerce/half/7.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/ecommerce/half/8.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/website/full/13.jpg'
    ],
    icon: (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
  ...
  },
  {
    ...
    color: '#0d9e8e',
    portfolioImages: [
      'https://webhyteimages.rightwebs.com/assets/images/portfolio/logo/1.jpg',
      'https://webhyteimages.rightwebs.com/assets/images/portfolio/logo/2.jpg',
      'https://webhyteimages.rightwebs.com/assets/images/portfolio/logo/3.jpg',
      'https://webhyteimages.rightwebs.com/assets/images/portfolio/logo/4.jpg',
      'https://webhyteimages.rightwebs.com/assets/images/portfolio/logo/5.jpg',
      'https://webhyteimages.rightwebs.com/assets/images/portfolio/logo/6.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/logo/9.jpeg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/logo/10.jpeg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/logo/11.jpeg'
    ],
    icon: (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
  ...
  },
  {
    ...
    color: '#14b8a6',
    portfolioImages: [
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/1.gif',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/2.gif',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/3.gif',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/4.gif',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/5.gif',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/6.gif',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/7.gif',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/8.gif',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/video/half/10.gif'
    ],
    icon: (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
  ...
  },
  {
    ...
    color: '#0f766e',
    portfolioImages: [
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/1.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/2.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/3.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/4.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/5.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/6.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/7.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/8.jpg',
      'https://webratek.com/webhyteimages.rightwebs.com/assets/images/portfolio/marketing/half/9.png'
    ],
    icon: (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
  ...
  return (
    <section id="portfolio" className="py-24 bg-[#F5F5F5] overflow-hidden border-t border-gray-50">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20 px-2">
          ...
          <div className="lg:col-span-3 pt-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[14px] font-bold tracking-tight uppercase font-inter bg-gradient-to-br from-[#1FC7A6] to-[#0F766E] bg-clip-text text-transparent">
                CREATIVE SOLUTIONS
              </span>
            </div>
          </div>
        ...
        {/* 2. Premium Minimalist Tab Navigation (Unified FlipButton) */}
