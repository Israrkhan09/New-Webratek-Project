                  ...
                  >
                    ...
                    <div className="mb-8">
                      <button
                        ...
                        className="flex items-center gap-3 text-gray-900 hover:text-[#006a63] transition-colors duration-300 py-2 group text-left"
                      >
                        {/* The ChevronLeft circle matching ChevronRight exactly */}
                        <span className="p-2 rounded-full border border-black/10 flex items-center justify-center group-hover:bg-black/5 group-hover:border-black/30 transition-all duration-300">
                          <svg className="w-5 h-5 text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                          </svg>
                        </span>
                        
                        <span className="font-bold text-[18px] tracking-tight text-gray-900 group-hover:text-[#006a63] transition-colors">
                          Main Menu
                        </span>
                      </button>
                    </div>
