...
export default function Loader() {
  ...
  useEffect(() => {
    ...
    const loaderTimer = setTimeout(() => setLoading(false), 2500);
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] flex items-center justify-center bg-black transition-transform duration-[1000ms] ease-[cubic-bezier(0.85,0,0.15,1)]
