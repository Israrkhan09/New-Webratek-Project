      ...
      <div className="section-container">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 mb-20 relative">
          ...
          <div className="lg:w-[75%]">
            <h2 className="text-[48px] md:text-[80px] lg:text-[130px] font-bold text-gray-900 leading-[1] tracking-tighter mb-10">
              Drive Digital <br /> Growth
            </h2>
            <p className="text-gray-600 text-[15px] md:text-[17px] lg:text-[18px] max-w-2xl leading-relaxed">
              Elevate your brand with data-driven marketing strategies. We combine SEO, social media, and paid advertising to ensure your message reaches the right audience at the right time.
            </p>
          </div>
        </div>
