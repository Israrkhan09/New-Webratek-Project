    ...
    <section className="min-h-screen w-full flex flex-col bg-[#2D6A4F] bg-gradient-to-b from-[#2D6A4F] via-[#1B4332] to-[#081C15] relative overflow-hidden">
      ...
      <div className="flex-grow flex flex-col items-center justify-start pt-[90px] md:pt-[100px]">
        ...
        <div className="flex flex-col items-center text-center max-w-[1440px] mx-auto z-10 w-full px-4">
          ...
          <div className="w-full max-w-none md:max-w-[1200px] mx-auto transform translate-y-4 overflow-visible flex justify-center">
            <img
              src={heroImage}
              alt="Hero Showcase"
              className="w-[135%] md:w-full max-w-none h-auto object-contain object-bottom drop-shadow-[0_20px_60px_rgba(0,0,0,0.45)] block scale-110 md:scale-100 origin-bottom transition-transform duration-300 flex-shrink-0"
            />
          </div>
        </div>
      </div>
