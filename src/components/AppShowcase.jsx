        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 mb-20 relative">
          ...
          <div className="lg:w-[75%]">
            ...
            <p className="text-gray-600 text-[17px] max-w-2xl leading-relaxed">
              From iOS to Android, we build scalable and intuitive mobile applications that provide a seamless user experience. Our apps are designed for performance, security, and growth.
            </p>
          </div>
        </div>
